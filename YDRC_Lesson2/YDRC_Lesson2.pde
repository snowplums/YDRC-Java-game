...
void draw() {
  ...
  //The condition in the if statement should call the collides function
...
void keyReleased() {
  ...
  //To find absolute value, use abs(). This will return the absolute value of whatever is in the parenthesis. 
